...
class pdf_parser
{
    ...
    protected function _readXref(&$result, $offset)
    {
        ...
        fseek($this->_f, $tempPos = $tempPos + $xrefPos + 4);         $data = fread($this->_f, $bytesPerCycle);
        ...
        $data = ltrim(substr($data, 0, $trailerPos));
                ...
                $found = preg_match_all("/(\r\n|\n|\r)/", substr($data, 0, 100), $m);         if ($found === 0) {
    ...
    protected function _readValue(&$c, $token = null)
    {
        ...
        switch ($token) {
                ...
                do {
                    for (; $openBrackets != 0 && $pos < $c->length; $pos++) {
                        switch (ord($c->buffer[$pos])) {
                            case 0x28:                                 $openBrackets++;
                                break;
                            case 0x29:                                 $openBrackets--;
                                break;
                            case 0x5C:                                 $pos++;
                        }
                    }
            ...
            case 'stream':
                ...
                $e = 0;                 if ($c->buffer[0] == chr(10) || $c->buffer[0] == chr(13))
                    $e++;
