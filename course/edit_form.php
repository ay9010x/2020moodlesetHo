...
class course_edit_form extends moodleform {
    ...
    function definition() {
        ...
        if(array_key_exists("mooccourse", $plugins)){
            $mform->addElement('date_time_selector', 'enddate', get_string('enddate', 'local_mooccourse'));
            $mform->addHelpButton('enddate', 'enddate' , 'local_mooccourse');
            $mform->setDefault('enddate', time() + WEEKSECS * 18);
            
            //$mform->addElement('selectyesno', 'whetheropen', get_string('whetheropen', 'local_mooccourse'));
            //$mform->addHelpButton('whetheropen', 'whetheropen', 'local_mooccourse');
            
            $mform->addElement('text','semester', get_string('semester', 'local_mooccourse'), 'maxlength="5"  size="5"');
            $mform->addHelpButton('semester', 'semester' ,'local_mooccourse');
            $mform->addRule('semester', get_string('missingsemester','local_mooccourse'), 'required', null, 'client');
    ...
    function validation($data, $files) {
        ...
        if($data['enddate'] <= $data['startdate']){
            $errors['enddate'] = get_string('enddateerror', 'local_mooccourse', $course->enddate);
        }
