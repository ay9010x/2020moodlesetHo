...
class shared extends \renderer_base {
    ...
    public static function appendices() {
        ...
        // Outline by YCJ
        $iconurl = $OUTPUT->pix_url('courses', 'theme');
        $gradebookicon = '<img src="'.$iconurl.'" class="svg-icon" alt="" role="presentation">';
         
        $links[] = array(
            'link' => 'blocks/course_menu/information.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("Outline 章節綱要")
        );
        ...
        $links[] = array(
            'link' => 'local/syllabus_week/index.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("{mlang en}Week Syllabus{mlang}{mlang zh_tw}預定進度{mlang}")
        );
        ...
        $links[] = array(
            'link' => 'local/syllabus_timeline/index.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("{mlang en}Allocation{mlang}{mlang zh_tw}時數分配表{mlang}")
        );
        
        // Bibliography by YCJ
        $iconurl = $OUTPUT->pix_url('pencil', 'theme');
        $gradebookicon = '<img src="'.$iconurl.'" class="svg-icon" alt="" role="presentation">';
         
        $links[] = array(
            'link' => 'blocks/course_menu/information.php?id='.$COURSE->id.'#ccbible',
            'title' => $gradebookicon.format_string("{mlang en}Bibliography{mlang}{mlang zh_tw}參考書目{mlang}")
        );
        
        // Q&A by YCJ
        $iconurl = $OUTPUT->pix_url('fp/help', 'theme');
        $gradebookicon = '<img src="'.$iconurl.'" class="svg-icon" alt="" role="presentation">';
         
        $links[] = array(
            'link' => 'blocks/course_menu/information.php?id='.$COURSE->id.'#ccqna',
            'title' => $gradebookicon.format_string("{mlang en}Q&A{mlang}{mlang zh_tw}常見問答集{mlang}")
        );*/
        
        // News by YCJ
        $iconurl = $OUTPUT->pix_url('searchpin', 'theme');
        $gradebookicon = '<img src="'.$iconurl.'" class="svg-icon" alt="" role="presentation">';
         
        $links[] = array(
            'link' => 'blocks/course_menu/news.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("{mlang en}News{mlang}{mlang zh_tw}公告{mlang}")
        );
        
        // Forum by YCJ
        $iconurl = $OUTPUT->pix_url('forumposts', 'theme');
        $gradebookicon = '<img src="'.$iconurl.'" class="svg-icon" alt="" role="presentation">';
         
        $links[] = array(
            'link' => 'blocks/course_menu/format/forum/view.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("{mlang en}forum{mlang}{mlang zh_tw}{mlang}")
        );
        
        // Messages by YCJ
        $iconurl = $OUTPUT->pix_url('messages', 'theme');
        $gradebookicon = '<img src="'.$iconurl.'" class="svg-icon" alt="" role="presentation">';
         
        $links[] = array(
            'link' => 'blocks/course_menu/message.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("{mlang en}Messages{mlang}{mlang zh_tw}通知{mlang}")
        );
        ...
        $links[] = array(
            'link' => 'blocks/course_menu/attendance.php?id='.$COURSE->id,
            'title' => $gradebookicon.format_string("{mlang en}Attendance{mlang}{mlang zh_tw}出席紀錄{mlang}")
        );
        ...
        //$o .= $enrollink.'<div id="coursetools-list">'.      by YCJ
