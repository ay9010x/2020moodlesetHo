...
$id            = required_param('id', PARAM_INT);                     $sortorder     = optional_param('sortorder', 'asc', PARAM_ALPHA);     $offset        = optional_param('offset', 0, PARAM_INT);              $pagelimit     = optional_param('pagelimit', 0, PARAM_INT);           $displayformat = optional_param('displayformat',-1, PARAM_INT);

$mode    = required_param('mode', PARAM_ALPHA);             $hook    = optional_param('hook','ALL', PARAM_CLEAN);       $sortkey = optional_param('sortkey','UPDATE', PARAM_ALPHA); 
