...
class HTMLPurifier_ConfigSchema_Validator
{
    ...
    public function validateId($id)
    {
        ...
        if (!$id instanceof HTMLPurifier_ConfigSchema_Interchange_Id) {
                        ...
                        $this->with($id, 'key')
            ->assertNotEmpty()
            ->assertIsString();         array_pop($this->context);
    }
    ...
    public function validateDirectiveAllowed($d)
    {
        ...
        $this->with($d, 'allowed')
            ->assertNotEmpty()
            ->assertIsLookup();         if (is_string($d->default) && !isset($d->allowed[$d->default])) {
    ...
    public function validateDirectiveValueAliases($d)
    {
        ...
        $this->with($d, 'valueAliases')
            ->assertIsArray();         $this->context[] = 'valueAliases';
    ...
    {
        $this->with($d, 'aliases')
            ->assertIsArray();         $this->context[] = 'aliases';
