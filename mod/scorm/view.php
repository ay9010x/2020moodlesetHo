...
$id = optional_param('id', '', PARAM_INT);       $a = optional_param('a', '', PARAM_INT);         $organization = optional_param('organization', '', PARAM_INT); $action = optional_param('action', '', PARAM_ALPHA);
$preventskip = optional_param('preventskip', '', PARAM_INT); 
if (!empty($id)) {
...
$launch = false; if (!empty($scorm->popup)) {
    $orgidentifier = '';
