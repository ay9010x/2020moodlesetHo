...
$PAGE->set_url('/grade/edit/moodleset/action.php', array('id'=>$courseid, 'action'=>$action, 'eid'=>$eid));
...
$returnurl = $gpr->get_return_url($CFG->wwwroot.'/grade/edit/moodleset/index.php?id='.$course->id);
