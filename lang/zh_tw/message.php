...
/**
 * Strings for component 'message', language 'zh_tw', branch 'MOODLE_31_STABLE'
 *
 * @package   message
...
$string['allusers'] = '所有用戶的簡訊';
$string['backupmessageshelp'] = '如果啟動，即時簡訊將會在網站自動備份時一併納入。';
$string['beepnewmessage'] = '收到彈出式通知時，發出提醒聲音';
...
$string['defaults'] = '預設';
$string['deletemessage'] = '刪除簡訊';
$string['deletemessageconfirmation'] = '你確定要刪除這一簡訊？它只會從你的簡訊歷史紀錄上刪除，但是那發送或接收這一簡訊的用戶仍可以看得到。';
...
$string['emailtagline'] = '這是在 " "{$a->sitename}"上傳送給您的簡訊的副本，請到{$a->url} 回應它。';
...
$string['errorwhilesendingmessage'] = '當傳送簡訊時發生錯誤，請稍後再嘗試';
$string['eventmessagecontactadded'] = '新增簡訊聯絡人';
$string['eventmessagecontactblocked'] = '已封鎖簡訊聯絡人';
$string['eventmessagecontactremoved'] = '已移除簡訊聯絡人';
$string['eventmessagecontactunblocked'] = '已解封鎖簡訊聯絡人';
$string['eventmessagedeleted'] = '已被刪除的簡訊';
$string['eventmessagesent'] = '簡訊已送出';
$string['eventmessageviewed'] = '簡訊已被檢視';
$string['forced'] = '強制的';
...
$string['includeblockedusers'] = '包括被封鎖的用戶';
$string['incomingcontacts'] = '進來的聯絡人 ({$a})';
$string['keywords'] = '關鍵字';
...
$string['timesent'] = '簡訊送出時刻';
$string['touserdoesntexist'] = '你不能傳送簡訊給一個不存在的用戶(編號{$a})';
$string['unabletomessageuser'] = '你無權傳送簡訊給這一用戶';
...
$string['userisblockingyou'] = '這一用戶把您封鎖，不讓您傳送簡訊給他';
$string['userisblockingyounoncontact'] = '{$a}只接收他們通訊錄中的人所發的簡訊，而您不在其中。';
$string['userssearchresults'] = '找到{$a}個用戶';
$string['viewconversation'] = '檢視對話內容';
