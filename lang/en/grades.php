...
$string['gradebook_simplesetup'] = 'Back to simple UI';        // by YCJ
$string['gradebook_originalsetup'] = 'Switch to advanced UI';    // by YCJ
$string['moodlesetsetup'] = 'Simple setup';    // by YCJ
