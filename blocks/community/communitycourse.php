...
require_login();
$courseid = required_param('courseid', PARAM_INT); $parentcourse = $DB->get_record('course', array('id' => $courseid), '*', MUST_EXIST);
...
$commentedcourseids = array(); $courseids = array(); $courseimagenumbers = array(); if (!empty($courses)) {
