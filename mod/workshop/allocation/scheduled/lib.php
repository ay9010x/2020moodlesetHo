...
require_once(dirname(dirname(__FILE__)) . '/lib.php');                  require_once(dirname(dirname(dirname(__FILE__))) . '/locallib.php');    require_once(dirname(dirname(__FILE__)) . '/random/lib.php');           require_once(dirname(__FILE__) . '/settings_form.php');                 
