...
$string['setpattern'] = 'Set Pattern'; 
$string['pattern'] = 'Pattern';
$string['cancelpattern'] = 'Cancel Pattern';
$string['pattern_assign'] = 'Pattern Assign';
$string['pattern_notice_onlinetext'] = 'notice:{$a} student assign type is [onlinetext] can not be set to pattern assign';
$string['pattern_notice_nofile'] = 'notice:{$a} student assign does not pay,can not be set go  pattern assign';
$string['pattern_notice_cancel'] = 'notice:{$a} student assign does not pattern assign, can not be cancel setting.';
$string['batchoperationconfirmsetpattern'] = 'Set up selected submissions to pattern assign?';
$string['batchoperationconfirmcancelpattern'] = 'Cancel selected submissions to pattern assign?';