<?php
    ...
    $PAGE->set_url('/blocks/course_menu/format/forum/view.php', $urlparams);
    $PAGE->requires->css('/blocks/course_menu/format/forum/styles.css');
    ...
    $PAGE->set_pagelayout('incourse');   // by YCJ
    $PAGE->set_pagetype('course-view-forum');    
    ...
    echo html_writer::start_tag('div', array('class'=>'forum-content'));   // by YCJ for forum lists in SNAP
    if($course->id != SITEID){
    ...
    require($CFG->dirroot .'/blocks/course_menu/format/forum/format.php');
    echo html_writer::end_tag('div');
    
    include_course_ajax($course, $modnamesused, NULL, NULL, 'nodragdrop');   // by YCJ
    echo $OUTPUT->footer();