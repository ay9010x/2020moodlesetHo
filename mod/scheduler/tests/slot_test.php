...
class mod_scheduler_slot_testcase extends advanced_testcase {
    ...
    protected $moduleid;      protected $courseid;      protected $schedulerid;     protected $teacherid;        protected $slotid;
    ...
    protected function setUp() {
        ...
        $this->teacherid = 2;          $this->slotid = $DB->get_field('scheduler_slots', 'id', array('schedulerid' => $scheduler->id), MUST_EXIST);
