...
class core_grade_category_testcase extends grade_base_testcase {
    ...
    public function test_grade_category() {
        ...
        $grade_category = new grade_category($params, false);
        $grade_category->insert();
        $this->grade_categories[50] = $grade_category;
    ...
    protected function sub_test_grade_category_update() {
        ...
        $grade_category->path = null;         $grade_category->depth = null;
    ...
    protected function sub_test_grade_category_generate_grades() {
        ...
        for ($i=0; $i<3; $i++) {
            ...
            $grade_grades[$i]->rawgrade = ($i+1)*2;             $grade_grades[$i]->finalgrade = ($i+1)*2;
    ...
    protected function sub_test_grade_category_apply_limit_rules() {
        ...
        $items[$this->grade_items[2]->id]->aggregationcoef = 1;         $grades = array($this->grade_items[0]->id=>5.374,
                        $this->grade_items[1]->id=>9.4743,
                        $this->grade_items[2]->id=>2.5474,
                        $this->grade_items[4]->id=>7.3754);
        $category->apply_limit_rules($grades, $items);
        ...
        $this->assertEquals($grades[$this->grade_items[2]->id], 2.5474);
                ...
                $items[$this->grade_items[2]->id]->aggregationcoef = 0;         $category = new grade_category();
        $category->droplow     = 1;
        $category->aggregation = GRADE_AGGREGATE_WEIGHTED_MEAN2;         $grades = array($this->grade_items[0]->id=>0,                         $this->grade_items[1]->id=>5,                         $this->grade_items[2]->id=>2,                         $this->grade_items[4]->id=>0);         $category->apply_limit_rules($grades, $items);
        ...
        $this->assertEquals($grades[$this->grade_items[4]->id], 0);
                ...
                $category = new grade_category();
        $category->droplow     = 2;
        $category->aggregation = GRADE_AGGREGATE_WEIGHTED_MEAN2;         $grades = array($this->grade_items[0]->id=>0,                         $this->grade_items[1]->id=>5,                         $this->grade_items[2]->id=>0,                         $this->grade_items[4]->id=>0);         $category->apply_limit_rules($grades, $items);
        $this->assertEquals(count($grades), 2);
        $this->assertEquals($grades[$this->grade_items[1]->id], 5);
        $this->assertEquals($grades[$this->grade_items[2]->id], 0);
                        ...
                        $category = new grade_category();
        $category->droplow     = 5;
        $category->aggregation = GRADE_AGGREGATE_WEIGHTED_MEAN2;         $grades = array($this->grade_items[0]->id=>0,                         $this->grade_items[1]->id=>5,                         $this->grade_items[2]->id=>6,                         $this->grade_items[4]->id=>1);        $category->apply_limit_rules($grades, $items);
        $this->assertEquals(count($grades), 0);

                $category = new grade_category();
        $category->droplow     = 4;
        $category->aggregation = GRADE_AGGREGATE_WEIGHTED_MEAN2;         $items[$this->grade_items[2]->id]->aggregationcoef = 1;         $grades = array($this->grade_items[0]->id=>0,                         $this->grade_items[1]->id=>5,                         $this->grade_items[2]->id=>6,                         $this->grade_items[4]->id=>1);        $category->apply_limit_rules($grades, $items);
        $this->assertEquals(count($grades), 1);
        $this->assertEquals($grades[$this->grade_items[2]->id], 6);

                $category = new grade_category();
        $category->droplow     = 1;
        $category->aggregation = GRADE_AGGREGATE_WEIGHTED_MEAN2;         $items[$this->grade_items[1]->id]->aggregationcoef = 1;         $grades = array($this->grade_items[0]->id=>1,                         $this->grade_items[1]->id=>1,                         $this->grade_items[2]->id=>1,                         $this->grade_items[4]->id=>1);        $category->apply_limit_rules($grades, $items);
        $this->assertEquals(count($grades), 3);
