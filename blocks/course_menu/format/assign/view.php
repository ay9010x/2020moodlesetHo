<?php
    ...
    $PAGE->set_url('/blocks/course_menu/format/assign/view.php', $urlparams);
    $PAGE->requires->css('/blocks/course_menu/format/assign/styles.css');
    ...
    $PAGE->set_pagetype('course-view-assign');    
    ...
    require($CFG->dirroot .'/blocks/course_menu/format/assign/format.php');
