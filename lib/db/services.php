...
$functions = array(
    ...
    'moodleset_create_users' => array(
        'classname' => 'tool_moodleset\external',
        'methodname' => 'create_users',
        'classpath' => '',
        'description' => '新增使用者(Create users)',
        'type' => 'write',
        'capabilities' => 'moodle/user:create',
        'services' => array(MODSET_OFFICIAL_SERVICE),
    ),
    'moodleset_user_update_users' => array(
        'classname' => 'tool_moodleset\external',
        'methodname' => 'update_users',
        'classpath' => '',
        'description' => '使用者資訊更新(Update users)',
        'type' => 'write',
        'capabilities' => 'moodle/user:update',
        'services' => array(MODSET_OFFICIAL_SERVICE),
    ),
    'moodleset_enrol_users' => array(
        'classname'   => 'tool_moodleset\external',         'methodname'  => 'enrol_users',
        'classpath'   => '',         'description' => '新增角色-加選(Enrol users)',
        'capabilities'=> 'enrol/manual:enrol',
        'type'        => 'write',
        'services' => array(MODSET_OFFICIAL_SERVICE),
    ),
    'moodleset_unenrol_users' => array(
        'classname'   => 'tool_moodleset\external',
        'methodname'  => 'unenrol_users',
        'classpath'   => '',         'description' => '移除角色-退選(Unenrol users)',
        'capabilities'=> 'enrol/manual:unenrol',
        'type'        => 'write',
        'services' => array(MODSET_OFFICIAL_SERVICE),
    ),
    'moodleset_create_categories' => array(
        'classname' => 'tool_moodleset\external',
        'methodname' => 'create_categories',
        'classpath' => '',
        'description' => '新增課程類別(Create categories)',
        'type' => 'write',
        'capabilities' => 'moodle/category:manage',
        'services' => array(MODSET_OFFICIAL_SERVICE),
    ),
    
    'moodleset_create_courses' => array(
        'classname' => 'tool_moodleset\external',
        'methodname' => 'create_courses',
        'classpath' => '',
        'description' => '新建課程(Create courses)',
        'type' => 'write',
        'capabilities' => 'moodle/course:create, moodle/course:visibility',
        'services' => array(MODSET_OFFICIAL_SERVICE),
    ),
    ...
    'moodleset_get_grades' => array(
        'classname' => 'tool_moodleset\external',
        'methodname' => 'get_grades',
        'classpath' => '',         'description' => '取得課程內學生成績(Get the user/s grades for a course)',
        'type' => 'read',
...
$services = array(
   'Moodle mobile web service'  => array(
        'functions' => array(),         'enabled' => 0,
        'restrictedusers' => 0,
        'shortname' => MOODLE_OFFICIAL_MOBILE_SERVICE,
        'downloadfiles' => 1,
        'uploadfiles' => 1
   ),
   'MoodleSET web service'  => array(
        'functions' => array(),         'enabled' => 1,
        'restrictedusers' => 1,
        'shortname' => MODSET_OFFICIAL_SERVICE,
        'downloadfiles' => 1,
        'uploadfiles' => 1
   ),
);
