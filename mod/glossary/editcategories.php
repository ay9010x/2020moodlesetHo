...
$id = required_param('id', PARAM_INT);                       $usedynalink = optional_param('usedynalink', 0, PARAM_INT);  $confirm     = optional_param('confirm', 0, PARAM_INT);      $name        = optional_param('name', '', PARAM_CLEAN);  
$action = optional_param('action', '', PARAM_ALPHA ); $hook   = optional_param('hook', '', PARAM_ALPHANUM); $mode   = optional_param('mode', '', PARAM_ALPHA);   
...
if (right_to_left()) {     $rightalignment = 'left';
    $leftalignment = 'right';
} else {
