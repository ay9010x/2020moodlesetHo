...
$cache_key = "cache_group_node_inwords";
// retrieve $cache
...
$data_node_inwords = array(
    ...
    $data_node_inword = json_encode($data_node_inwords);
    $_SESSION[$cache_key] = $data_node_inword;
}
else {
    $data_node_inword = $_SESSION[$cache_key];
}

echo urldecode($data_node_inword);
/***************************************************/