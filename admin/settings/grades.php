...
if (has_capability('moodle/grade:manage', $systemcontext)
 or has_capability('moodle/grade:manageletters', $systemcontext)) { 
    ...
    if ($ADMIN->fulltree) {
        ...
        $defaultvisible = array(GRADE_AGGREGATE_SUM, GRADE_AGGREGATE_WEIGHTED_MEAN);   // by YCJ

        $defaults = array('value' => GRADE_AGGREGATE_WEIGHTED_MEAN, 'forced' => false, 'adv' => false);      // by YCJ
