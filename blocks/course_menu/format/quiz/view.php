<?php
    ...
    $PAGE->set_url('/blocks/course_menu/format/quiz/view.php', $urlparams);
    $PAGE->requires->css('/blocks/course_menu/format/quiz/styles.css');
    ...
    $PAGE->set_pagetype('course-view-quiz');    
    ...
    require($CFG->dirroot .'/blocks/course_menu/format/quiz/format.php');
