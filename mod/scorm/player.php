...
$id = optional_param('cm', '', PARAM_INT);                          $a = optional_param('a', '', PARAM_INT);                            $scoid = required_param('scoid', PARAM_INT);                        $mode = optional_param('mode', 'normal', PARAM_ALPHA);              $currentorg = optional_param('currentorg', '', PARAM_RAW);          $newattempt = optional_param('newattempt', 'off', PARAM_ALPHA);     $displaymode = optional_param('display', '', PARAM_ALPHA);
...
echo html_writer::end_div(); echo html_writer::end_div(); echo html_writer::tag('noscript', html_writer::div(get_string('noscriptnoscorm', 'scorm'), '', array('id' => 'noscript')));
