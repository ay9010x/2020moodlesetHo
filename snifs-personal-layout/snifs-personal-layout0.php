...
dd=<?php echo $_GET["d"]; ?>;
forum=<?php echo $_GET["forum"]; ?>;//控制抓內文
course=<?php echo $_GET["course"]; ?>;//控制抓小組
</script>
	...
	<!--判定抓個人或小組資料-->
					...
					<!--<script src="js/auto_exec_jieba.js" type="text/javascript" course_id = < ?php /*echo $course;*/ ?>>//試試看新的</script>
-->

<script type="text/javascript">
					var _exec_jieba = function () {
						console.log('/jieba-snifs/snifs_discusscut.php1');
					...
					$(function () {
						console.log('/jieba-snifs/snifs_discusscut.php2');
						_exec_jieba();
					});
