...
class mod_assign_locallib_testcase extends mod_assign_base_testcase {
    ...
    public function test_reset_userdata() {
        ...
        $this->assertEquals($now + 24*60*60, $instance->duedate);
                ...
                $assignduedate = $instance->duedate;         $data->timeshift = 2*24*60*60;
    ...
    public function test_update_calendar() {
        ...
        $this->assertSame('link', $event->description);     
                $instance = $assign->get_instance();
        ...
        $event = $DB->get_record('event', $params);
        $this->assertNotEmpty($event);
        $this->assertSame('new', $event->description);     
...
";
    ...
    public function test_can_view_blind_details() {
        ...
        $student = $this->students[0];                $teacher = $this->getDataGenerator()->create_user();
        ...
        $gradingtable = new assign_grading_table($assign, 1, '', 0, true);
        $output = $assign->get_renderer()->render($gradingtable);
        $this->assertEquals(true, strpos($output, get_string('hiddenuser', 'assign')));            $this->assertEquals(false, strpos($output, fullname($student)));    
