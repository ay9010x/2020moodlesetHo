...
class workshop_comments_strategy implements workshop_strategy {
    ...
    public function save_edit_strategy_form(stdclass $data) {
        ...
        $records    = $data->comments;          $todelete   = array();              
    ...
    protected function delete_dimensions(array $ids) {
        ...
        $fs = get_file_storage();
        foreach ($ids as $id) {
            if (!empty($id)) {                   $fs->delete_area_files($PAGE->context->id, 'workshopform_comments', 'description', $id);
            }
        }
    ...
    protected function prepare_database_fields(stdclass $raw) {
        ...
        $cook               = new stdclass();         $cook->comments = array();        
