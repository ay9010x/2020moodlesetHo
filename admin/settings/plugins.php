...
if ($hassiteconfig) {
    ...
    $temp->add(new admin_setting_configselect('guestloginbutton', new lang_string('guestloginbutton', 'auth'),
                                              new lang_string('showguestlogin', 'auth'), '0', array('0'=>new lang_string('hide'), '1'=>new lang_string('show'))));
    ...
    $fileinfo = portfolio_filesize_info();     $fileoptions = $fileinfo['options'];
