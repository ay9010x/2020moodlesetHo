...
class core_moodlelib_testcase extends advanced_testcase {
    ...
    public function test_clean_param_text() {
        ...
        $this->assertSame('a>c>', clean_param('a><xx >c>', PARAM_TEXT));         $this->assertSame('a', clean_param('a<b', PARAM_TEXT));
        $this->assertSame('a>b', clean_param('a>b', PARAM_TEXT));
        $this->assertSame('<lang lang="en">a>a</lang>', clean_param('<lang lang="en">a>a</lang>', PARAM_TEXT));         $this->assertSame('a', clean_param('<lang lang="en">a<a</lang>', PARAM_TEXT));
    ...
    public function test_shorten_text_no_spaces() {
                $text = "<h1>123456789</h1>";         $this->assertSame("<h1>12345...</h1>", shorten_text($text, 8));
    }

    public function test_shorten_text_utf8_european() {
                        $text = "Žluťoučký koníček přeskočil";
        $this->assertSame($text, shorten_text($text));         $this->assertSame("Žluťoučký koníče...", shorten_text($text, 19, true));
    ...
    public function test_shorten_text_utf8_oriental() {
        ...
        $this->assertSame($text, shorten_text($text));         $this->assertSame("言語設定言語...", shorten_text($text, 9, true));
        ...
        $this->assertSame($text, shorten_text($text));         $this->assertSame("简体中文简体...", shorten_text($text, 9, true));
    ...
    public function test_usergetdate() {
        ...
        $USER->timezone = 2;
        $ts = 1261540267; 
        $arr = usergetdate($ts, 1);         $arr = array_values($arr);
        ...
        $arr = usergetdate($ts);         $arr = array_values($arr);
    ...
    public function test_some_moodle_special_dst() {
        ...
        $phpres = $phpdt->format('Y/m/d H:i:s');         $moodleres = userdate($stamp, '%Y/%m/%d %H:%M:%S', 'Europe/Tallinn', false);         $this->assertSame($expectation, $phpres);
        $this->assertSame($expectation, $moodleres);

                $expectation = '2013/04/07 23:30:00';
        $phpdt = DateTime::createFromFormat('U', $stamp, new DateTimeZone('UTC'));
        $phpdt->setTimezone(new DateTimeZone('America/St_Johns'));
        $phpres = $phpdt->format('Y/m/d H:i:s');         $moodleres = userdate($stamp, '%Y/%m/%d %H:%M:%S', 'America/St_Johns', false);         $this->assertSame($expectation, $phpres);
        $this->assertSame($expectation, $moodleres);
    ...
    public function test_userdate() {
        ...
        $testvalues = array(
            array(
                ...
                'timezone' => '0.0',                 'expectedoutput' => 'Friday, 1 July 2011, 10:00 AM'
            ),
            array(
                'time' => '1309514400',
                'usertimezone' => 'America/Moncton',
                'timezone' => '99',                 'expectedoutput' => 'Friday, 1 July 2011, 7:00 AM'
            ),
            array(
                'time' => '1309514400',
                'usertimezone' => 'America/Moncton',
                'timezone' => 'America/Moncton',                 'expectedoutput' => 'Friday, 1 July 2011, 7:00 AM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => 'America/Moncton',
                'timezone' => '0.0',                 'expectedoutput' => 'Saturday, 1 January 2011, 10:00 AM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => 'America/Moncton',
                'timezone' => '99',                 'expectedoutput' => 'Saturday, 1 January 2011, 6:00 AM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => 'America/Moncton',
                'timezone' => 'America/Moncton',                 'expectedoutput' => 'Saturday, 1 January 2011, 6:00 AM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => '2',
                'timezone' => '99',                 'expectedoutput' => 'Saturday, 1 January 2011, 12:00 PM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => '-2',
                'timezone' => '99',                 'expectedoutput' => 'Saturday, 1 January 2011, 8:00 AM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => '-10',
                'timezone' => '2',                 'expectedoutput' => 'Saturday, 1 January 2011, 12:00 PM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => '-10',
                'timezone' => '-2',                 'expectedoutput' => 'Saturday, 1 January 2011, 8:00 AM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => '-10',
                'timezone' => 'random/time',                 'expectedoutput' => 'Saturday, 1 January 2011, 6:00 PM'
            ),
            array(
                'time' => '1293876000 ',
                'usertimezone' => '20',                 'timezone' => '99',                     'expectedoutput' => 'Saturday, 1 January 2011, 6:00 PM'
            ),
        );
    ...
    public function test_make_timestamp() {
        ...
        $testvalues = array(
            array(
                ...
                'seconds' => '00',
                'timezone' => '0.0',
                'applydst' => false,                 'expectedoutput' => '1309514400'             ),
            array(
                'usertimezone' => 'America/Moncton',
                'year' => '2011',
                'month' => '7',
                ...
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '99',                  'applydst' => false,                 'expectedoutput' => '1309528800'
            ),
            array(
                'usertimezone' => 'America/Moncton',
                'year' => '2011',
                ...
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '99',                 'applydst' => true,                 'expectedoutput' => '1309525200'
            ),
            array(
                'usertimezone' => 'America/Moncton',
                'year' => '2011',
                ...
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => 'America/Moncton',                 'applydst' => true,                 'expectedoutput' => '1309525200'
            ),
            array(
                'usertimezone' => '2',                 'year' => '2011',
                'month' => '7',
                'day' => '1',
                'hour' => '10',
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '99',                 'applydst' => true,                 'expectedoutput' => '1309507200'
            ),
            array(
                'usertimezone' => '-2',                 'year' => '2011',
                'month' => '7',
                ...
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '99',                 'applydst' => true,                 'expectedoutput' => '1309521600'
            ),
            array(
                'usertimezone' => '-10',                 'year' => '2011',
                'month' => '7',
                'day' => '1',
                'hour' => '10',
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '2',                  'applydst' => true,                 'expectedoutput' => '1309507200'
            ),
            array(
                'usertimezone' => '-10',                 'year' => '2011',
                'month' => '7',
                ...
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '-2',                 'applydst' => true,                 'expectedoutput' => '1309521600'
            ),
            array(
                'usertimezone' => '-10',                 'year' => '2011',
                'month' => '7',
                ...
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => 'random/time',                 'applydst' => true,                          'expectedoutput' => '1309485600'
            ),
            array(
                'usertimezone' => '-14',                 'year' => '2011',
                'month' => '7',
                'day' => '1',
                'hour' => '10',
                'minutes' => '00',
                'seconds' => '00',
                'timezone' => '99',                 'applydst' => true,                 'expectedoutput' => '1309485600'
            )
        );
    ...
    public function test_delete_user() {
        ...
        $record->id = 666;
        $record->username = 'xx';
        $this->assertFalse($DB->record_exists('user', array('id'=>666)));         $result = delete_user($record);
    ...
    public function test_complete_user_login() {
        ...
        @complete_user_login($loginuser);         $this->assertSame($loginuser, $USER);
    ...
    public function test_setnew_password_and_mail() {
        ...
        $user = $this->getDataGenerator()->create_user();
                ...
                $sink = $this->redirectEvents();
        $sink2 = $this->redirectEmails();         setnew_password_and_mail($user);
        $events = $sink->get_events();
        $sink->close();
        $sink2->close();
        $event = array_pop($events);
    ...
    public function test_complex_random_string() {
        ...
        $this->assertEquals(28, strlen($result), '', 4);         $this->assertRegExp('/^[' . $pool . ']+$/', $result);
