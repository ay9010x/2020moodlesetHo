...
$string['departmentmanager'] = '系所管理員';
$string['departmentmanagerdescription'] = '系所管理員可以管理自己的系所課程類別。';
$string['departmentassistant'] = '系所助理';
$string['departmentassistantdescription'] = '系所助理可以管理自己的系所課程類別，但僅可以查詢、觀看，不能編修。';
...
$string['auditor'] = '旁聽生';
$string['defaultauditor'] = '旁聽生';
$string['auditordescription'] = '旁聽生可參與課程中的活動，但不計分。';
$string['defaultauditordescription'] = '旁聽生可參與課程中的活動，但不計分。';
...
$string['emailconfirmation'] = '親愛的使用者,您好:

歡迎加入MoodleSET平台，您所申請的帳號已獲核准。如果您未做任何的申請，請忽略此郵件。

您的帳號權限為<u>系所管理員</u>,這將有助於您可以在系所類別下建立課程。

很高興有您的加入,期待MoodleSET平台可以為 貴校帶來數位學習的優質運用,如果您需要幫助,歡迎造訪我們的網站<a href ="http://www.click-ap.com" target="_blank">http://www.click-ap.com</a>,抑或寫信到<a href="mailto:service@click-ap.com" target="_blank">service@click-ap.com</a>,我們將盡力協助您解決問題。

什麼是<a href ="http://www.click-ap.com/moodleset" target="_blank">MoodleSET</a>?
...
$string['eventdashboardreset'] = '儀錶板重設';
$string['eventdashboardsreset'] = '儀錶板重設';
$string['eventdashboardviewed'] = '儀錶板已檢視';
...
$string['teacherassistant'] = '助教';
$string['teacherassistantdescription'] = '助教可以參與課程的教學活動與學生評分。';
