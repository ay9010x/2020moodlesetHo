...
define(['jquery', 'core/ajax', 'core/log', 'core/notification', 'core/templates', 'core/config', 'core/str'],
    ...
    var templateLoaded = function(templateName, source, originalSource) {
        str.get_string('templateselected', 'tool_moodleset', templateName).done(function(s) {
        ...
        if (context) {
            ...
            str.get_string('templatehasnoexample', 'tool_moodleset').done(function(s) {
