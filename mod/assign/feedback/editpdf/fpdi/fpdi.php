...
class FPDI extends FPDF_TPL
{
    ...
    public function useTemplate($tplIdx, $x = null, $y = null, $w = 0, $h = 0, $adjustPageSize = false)
    {
        ...
        $this->_out('q 0 J 1 w 0 j 0 G 0 g');         $size = parent::useTemplate($tplIdx, $x, $y, $w, $h);
        $this->_out('Q');
    ...
    protected function _putimportedobjects()
    {
        foreach($this->parsers AS $filename => $p) {
            ...
            while(($n = key($this->_objStack[$filename])) !== null) {
                ...
                $this->_out("\nendobj");
                $this->_objStack[$filename][$n] = null;                 unset($this->_objStack[$filename][$n]);
    ...
    protected function _putformxobjects()
    {
        ...
        foreach($this->_tpls AS $tplIdx => $tpl) {
            ...
            if (isset($tpl['resources'])) {
                ...
                $this->_writeValue($tpl['resources']);             } else {
